...
<h1>Formal Process for LTI Consumer Certification</h1>
<p>Quick Link: <a href="index.php">Certification Overview</a> |
<a href="lmssetup.php">Test Setup</a> | <a href="imsblti-consumer-cert-v1p0.doc">Download Certification Report</a>
</p>
<p>
Welcome to IMS LTI Consumer Certification Testing.  The goal of the IMS
...
<p>
The certification
is for a particular version of an LMS or LMS extension
and the certification must
be re-done for each new release of the software.
In the case where the LTI capability is added to an LMS
through a <i>separately released</i> extention such as a
Building Block, Module, PowerLink, etc.,
then the certification is for the extention and version of the extension.
If the capability is built into the LMS and released as part of the
LMS, then the LMS and version are certified.
<p>
...
report and issues the certification and adds the LMS(including
...
beyond
those which are <i>strictly required</i> by the IMS
...
<a href="imsblti-consumer-cert-v1p0.doc">Certification Report</a>.  This
document must be filled out and submitted to
<a href="mailto:conformance@imsglobal.org">conformance@imsglobal.org</a>
along with a PDF showing the test status once your software has passed the
test.
</p>
<p>
...
You must choose a password that is at least 10 characters.
...
few of the "Free Pass" or "Fail Only" tests marked as "OK" as shown
in this image:
<p><center>
<img src="lms_01_status.png" width="700px">
</center></p>
...
<p><center>
<img src="lms_01_test.png" width="700px">
</center></p>
...
wants the following combinations: (1) neither name nor mail
address, (2) name only, (3) mail address only, and (4)
both name and mail address.  The quick way to pass these tests
...
have a name and E-Mail address in the LMS.
